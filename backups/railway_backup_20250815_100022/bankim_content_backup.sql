...
ALTER FUNCTION public.get_content_by_screen(p_screen_location character varying, p_language_code character varying) OWNER TO postgres;
...
ALTER FUNCTION public.get_content_with_fallback(p_content_key character varying, p_language_code character varying) OWNER TO postgres;
...
ALTER FUNCTION public.get_property_ownership_ltv(property_ownership_type text) OWNER TO postgres;
...
ALTER FUNCTION public.update_cities_updated_at() OWNER TO postgres;
...
ALTER SEQUENCE public.content_categories_id_seq OWNER TO postgres;
...
ALTER TABLE public.credit_data_backup_20250127 OWNER TO postgres;
...
ALTER TABLE public.test11 OWNER TO postgres;
...
ALTER SEQUENCE public.test11_id_seq OWNER TO postgres;
...
ALTER VIEW public.v_content_by_screen OWNER TO postgres;
...
ALTER VIEW public.v_content_stats OWNER TO postgres;
...
ALTER VIEW public.view_mortgage_all_steps OWNER TO postgres;
...
ALTER VIEW public.view_mortgage_calculator OWNER TO postgres;
...
ALTER VIEW public.view_mortgage_categories_summary OWNER TO postgres;
...
ALTER VIEW public.view_mortgage_step1 OWNER TO postgres;
...
ALTER VIEW public.view_mortgage_step2 OWNER TO postgres;
...
ALTER VIEW public.view_mortgage_step3 OWNER TO postgres;
...
ALTER VIEW public.view_mortgage_step4 OWNER TO postgres;
...
COPY public.admin_users (id, username, email, full_name, role, is_active, created_at, last_login) FROM stdin;
1	admin	admin@bankim.com	System Administrator	super_admin	t	2025-07-17 16:53:42.284005	\N
2	content_manager	content@bankim.com	Content Manager	content_manager	t	2025-07-17 16:53:42.284005	\N
\.
...
1465	mortgage_step1.field.city	text	form	mortgage_step1	label	\N	t	\N	new	2025-07-29 21:29:29.162912	2025-07-30 21:48:08.757559	1	1	\N
...
4536	1636	he	מקור הכנסה עיקרי	f	draft	2025-07-31 19:54:23.169109	2025-07-31 19:54:23.169109	\N	\N	\N
4537	1636	en	Main source of income	f	draft	2025-07-31 19:54:23.169109	2025-07-31 19:54:23.169109	\N	\N	\N
4538	1636	ru	Основной источник дохода	f	draft	2025-07-31 19:54:23.169109	2025-07-31 19:54:23.169109	\N	\N	\N
4539	1637	he	הכנסה נוספת	f	draft	2025-07-31 19:54:23.169109	2025-07-31 19:54:23.169109	\N	\N	\N
4540	1637	en	Additional income	f	draft	2025-07-31 19:54:23.169109	2025-07-31 19:54:23.169109	\N	\N	\N
4541	1637	ru	Дополнительный доход	f	draft	2025-07-31 19:54:23.169109	2025-07-31 19:54:23.169109	\N	\N	\N
...
4106	1465	he	עיר בא נמצא הנכס??	f	approved	2025-07-29 21:29:29.162912	2025-07-29 21:29:29.162912	1	\N	\N
4107	1465	ru	Город расположения недвижимости	f	approved	2025-07-29 21:29:29.162912	2025-07-29 21:29:29.162912	1	\N	\N
...
SELECT pg_catalog.setval('public.content_items_id_seq', 2400, true);
...
SELECT pg_catalog.setval('public.content_translations_id_seq', 6404, true);
