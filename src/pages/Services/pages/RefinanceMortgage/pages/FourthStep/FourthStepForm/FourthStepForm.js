...
const FourthStepForm = () => {
    ...
    return (_jsxs(FormContainer, { children: [_jsx(FormCaption, { title: t('calculate_mortgage_final') }), _jsx(UserParams, { cost: mortgageParameters?.priceOfEstate, initialPayment: mortgageParameters?.mortgageBalance, period: mortgageParameters?.period, nameSurname: userData?.nameSurname, phoneNumber: userData?.phoneNumber }), _jsx(AlertWarning, { text: t('calculate_mortgage_warning') }), _jsx(Row, { children: _jsx(Filter, {}) }), _jsx(BankOffers, {})] }));
};
