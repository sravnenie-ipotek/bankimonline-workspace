...
export const borrowersSlice = createSlice({
    ...
    reducers: {
        ...
        updateSourceOfIncomeModal: (state, action) => {
            const index = state.sourceOfIncomeModal.findIndex((item) => item.id === action.payload.id);
            if (index !== -1) {
        ...
        deleteSourceOfIncomeModal: (state, action) => {
            state.sourceOfIncomeModal = state.sourceOfIncomeModal.filter((item) => item.id !== action.payload.id);
        },
        updateAdditionalIncomeModal: (state, action) => {
            const index = state.additionalIncomeModal.findIndex((item) => item.id === action.payload.id);
            if (index !== -1) {
        ...
        deleteAdditionalIncomeModal: (state, action) => {
            state.additionalIncomeModal = state.additionalIncomeModal.filter((item) => item.id !== action.payload.id);
        },
        updateObligationModal: (state, action) => {
            const index = state.obligationModal.findIndex((item) => item.id === action.payload.id);
            if (index !== -1) {
        ...
        deleteObligationModal: (state, action) => {
            state.obligationModal = state.obligationModal.filter((item) => item.id !== action.payload.id);
        },
...
export const { updateSourceOfIncomeModal, deleteSourceOfIncomeModal, updateAdditionalIncomeModal, deleteAdditionalIncomeModal, updateObligationModal, deleteObligationModal, updateOtherBorrowers, deleteOtherBorrowers, openBorrowersPage, } = borrowersSlice.actions;
