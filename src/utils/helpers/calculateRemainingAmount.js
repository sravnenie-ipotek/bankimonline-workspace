const calculateRemainingAmount = (remainingMortgageAmount, remainingYears, annualRate = 5) => {
    ...
    const totalAmountToPay = remainingMortgageAmount * (1 + (annualRate * remainingYears) / 100);
