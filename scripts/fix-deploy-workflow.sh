...
# Fix the deploy workflow YAML syntax issues
# This script replaces problematic heredocs with simpler commands

echo "🔧 Fixing deploy workflow YAML syntax..."

# Backup original
cp .github/workflows/deploy-multi-env.yml .github/workflows/deploy-multi-env.yml.backup

# Create fixed version
cat > .github/workflows/deploy-multi-env-fixed.yml << 'WORKFLOW_EOF'
...
mv .github/workflows/deploy-multi-env-fixed.yml .github/workflows/deploy-multi-env.yml

echo "✅ Deploy workflow fixed!"
echo "The workflow has been simplified to avoid YAML syntax issues with heredocs."