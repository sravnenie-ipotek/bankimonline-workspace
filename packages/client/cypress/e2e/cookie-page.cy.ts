describe('Cookie Page Tests', () => {
  ...
  describe('Basic Functionality', () => {
    ...
    it('should display the cookie policy content', () => {
  ...
  describe('Navigation', () => {
    ...
    it('should navigate back when back button is clicked', () => {
      // First navigate to cookie page from home
      cy.visit('/')
      cy.url().should('eq', Cypress.config().baseUrl + '/')
      
      // Then go to cookie page
      cy.visit('/cookie')
      cy.url().should('include', '/cookie')
  ...
  describe('Error Handling', () => {
    ...
    it('should render with component integration', () => {
      // Verify Cookie component properly integrates with TextPage
      cy.visit('/cookie')
      cy.get('[class*="page-header__title"]').should('exist')
      cy.get('[class*="page-text"]').should('exist')
    })
  ...
  describe('Cookie Policy Specific Tests', () => {
    it('should be accessible from main navigation', () => {
      cy.visit('/')
      // Check if cookie page is listed in available services
      cy.contains('Cookie').should('exist')
    })

    it('should display cookie policy content appropriately', () => {
      cy.visit('/cookie')
      
      // Cookie policy should have title and content
      cy.get('[class*="page-header__title"]').should('be.visible')
      cy.get('[class*="page-text"]').should('be.visible')
    ...
    it('should integrate properly with terms and privacy pages', () => {
