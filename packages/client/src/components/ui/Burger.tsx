        ...
        <div>
          ...
          >
            <img
              ...
              alt=""
              className="sidebar-iconinstagram"
              style={{
        ...
        <div>
          ...
          >
            <img
              ...
              alt=""
              className="sidebar-iconfacebook"
              style={{
                transform: 'rotate(270deg)',
              }}
            />
        ...
        <div>
          ...
          >
            <img
              ...
              alt=""
              className="sidebar-icontwitterI111"
              style={{
                transform: 'rotate(270deg)',
              }}
            />
