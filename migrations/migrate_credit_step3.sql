...
-- Main title
('calculate_credit_step3_title', 'title', 'navigation', 'calculate_credit_3', 'Step 3 main title', true, 'calculate_credit_step3_title', NOW(), NOW()),

-- Main Source of Income field
('calculate_credit_main_source_income', 'field_label', 'income_details', 'calculate_credit_3', 'Main source of income field label', true, 'calculate_credit_main_source_income', NOW(), NOW()),
('calculate_credit_main_source_income_ph', 'placeholder', 'income_details', 'calculate_credit_3', 'Main source of income placeholder', true, 'calculate_credit_main_source_income_ph', NOW(), NOW()),
('calculate_credit_main_source_income_option_1', 'option', 'income_details', 'calculate_credit_3', 'Salary', true, 'calculate_credit_main_source_income_option_1', NOW(), NOW()),
('calculate_credit_main_source_income_option_2', 'option', 'income_details', 'calculate_credit_3', 'Self-employed', true, 'calculate_credit_main_source_income_option_2', NOW(), NOW()),
('calculate_credit_main_source_income_option_3', 'option', 'income_details', 'calculate_credit_3', 'Pension', true, 'calculate_credit_main_source_income_option_3', NOW(), NOW()),
('calculate_credit_main_source_income_option_4', 'option', 'income_details', 'calculate_credit_3', 'Unemployment benefits', true, 'calculate_credit_main_source_income_option_4', NOW(), NOW()),
('calculate_credit_main_source_income_option_5', 'option', 'income_details', 'calculate_credit_3', 'Investment income', true, 'calculate_credit_main_source_income_option_5', NOW(), NOW()),
('calculate_credit_main_source_income_option_6', 'option', 'income_details', 'calculate_credit_3', 'Student allowance', true, 'calculate_credit_main_source_income_option_6', NOW(), NOW()),
('calculate_credit_main_source_income_option_7', 'option', 'income_details', 'calculate_credit_3', 'Other', true, 'calculate_credit_main_source_income_option_7', NOW(), NOW()),

-- Additional Income field
('calculate_credit_additional_income', 'field_label', 'income_details', 'calculate_credit_3', 'Additional income field label', true, 'calculate_credit_additional_income', NOW(), NOW()),
('calculate_credit_additional_income_ph', 'placeholder', 'income_details', 'calculate_credit_3', 'Additional income placeholder', true, 'calculate_credit_additional_income_ph', NOW(), NOW()),
('calculate_credit_additional_income_option_1', 'option', 'income_details', 'calculate_credit_3', 'Part-time work', true, 'calculate_credit_additional_income_option_1', NOW(), NOW()),
('calculate_credit_additional_income_option_2', 'option', 'income_details', 'calculate_credit_3', 'Freelance work', true, 'calculate_credit_additional_income_option_2', NOW(), NOW()),
('calculate_credit_additional_income_option_3', 'option', 'income_details', 'calculate_credit_3', 'Rental income', true, 'calculate_credit_additional_income_option_3', NOW(), NOW()),
('calculate_credit_additional_income_option_4', 'option', 'income_details', 'calculate_credit_3', 'Investment returns', true, 'calculate_credit_additional_income_option_4', NOW(), NOW()),
('calculate_credit_additional_income_option_5', 'option', 'income_details', 'calculate_credit_3', 'Business income', true, 'calculate_credit_additional_income_option_5', NOW(), NOW()),
('calculate_credit_additional_income_option_6', 'option', 'income_details', 'calculate_credit_3', 'Government benefits', true, 'calculate_credit_additional_income_option_6', NOW(), NOW()),
('calculate_credit_additional_income_option_7', 'option', 'income_details', 'calculate_credit_3', 'None', true, 'calculate_credit_additional_income_option_7', NOW(), NOW()),

-- Professional Sphere field
('calculate_credit_professional_sphere', 'field_label', 'income_details', 'calculate_credit_3', 'Professional sphere field label', true, 'calculate_credit_professional_sphere', NOW(), NOW()),
('calculate_credit_professional_sphere_ph', 'placeholder', 'income_details', 'calculate_credit_3', 'Professional sphere placeholder', true, 'calculate_credit_professional_sphere_ph', NOW(), NOW()),
('calculate_credit_professional_sphere_option_1', 'option', 'income_details', 'calculate_credit_3', 'Technology/IT', true, 'calculate_credit_professional_sphere_option_1', NOW(), NOW()),
('calculate_credit_professional_sphere_option_2', 'option', 'income_details', 'calculate_credit_3', 'Healthcare/Medical', true, 'calculate_credit_professional_sphere_option_2', NOW(), NOW()),
('calculate_credit_professional_sphere_option_3', 'option', 'income_details', 'calculate_credit_3', 'Education', true, 'calculate_credit_professional_sphere_option_3', NOW(), NOW()),
('calculate_credit_professional_sphere_option_4', 'option', 'income_details', 'calculate_credit_3', 'Finance/Banking', true, 'calculate_credit_professional_sphere_option_4', NOW(), NOW()),
('calculate_credit_professional_sphere_option_5', 'option', 'income_details', 'calculate_credit_3', 'Legal services', true, 'calculate_credit_professional_sphere_option_5', NOW(), NOW()),
('calculate_credit_professional_sphere_option_6', 'option', 'income_details', 'calculate_credit_3', 'Manufacturing', true, 'calculate_credit_professional_sphere_option_6', NOW(), NOW()),
('calculate_credit_professional_sphere_option_7', 'option', 'income_details', 'calculate_credit_3', 'Sales/Marketing', true, 'calculate_credit_professional_sphere_option_7', NOW(), NOW()),
('calculate_credit_professional_sphere_option_8', 'option', 'income_details', 'calculate_credit_3', 'Public service', true, 'calculate_credit_professional_sphere_option_8', NOW(), NOW()),
('calculate_credit_professional_sphere_option_9', 'option', 'income_details', 'calculate_credit_3', 'Construction', true, 'calculate_credit_professional_sphere_option_9', NOW(), NOW()),
('calculate_credit_professional_sphere_option_10', 'option', 'income_details', 'calculate_credit_3', 'Other', true, 'calculate_credit_professional_sphere_option_10', NOW(), NOW()),

-- Monthly Income field
('calculate_credit_monthly_income', 'field_label', 'income_details', 'calculate_credit_3', 'Monthly income field label', true, 'calculate_credit_monthly_income', NOW(), NOW()),
('calculate_credit_monthly_income_ph', 'placeholder', 'income_details', 'calculate_credit_3', 'Monthly income placeholder', true, 'calculate_credit_monthly_income_ph', NOW(), NOW()),

-- Existing Debts field
('calculate_credit_existing_debts', 'field_label', 'income_details', 'calculate_credit_3', 'Existing debts field label', true, 'calculate_credit_existing_debts', NOW(), NOW()),
('calculate_credit_existing_debts_ph', 'placeholder', 'income_details', 'calculate_credit_3', 'Existing debts placeholder', true, 'calculate_credit_existing_debts_ph', NOW(), NOW()),
('calculate_credit_existing_debts_option_1', 'option', 'income_details', 'calculate_credit_3', 'Mortgage loan', true, 'calculate_credit_existing_debts_option_1', NOW(), NOW()),
('calculate_credit_existing_debts_option_2', 'option', 'income_details', 'calculate_credit_3', 'Personal loan', true, 'calculate_credit_existing_debts_option_2', NOW(), NOW()),
('calculate_credit_existing_debts_option_3', 'option', 'income_details', 'calculate_credit_3', 'Credit card debt', true, 'calculate_credit_existing_debts_option_3', NOW(), NOW()),
('calculate_credit_existing_debts_option_4', 'option', 'income_details', 'calculate_credit_3', 'Car loan', true, 'calculate_credit_existing_debts_option_4', NOW(), NOW()),
('calculate_credit_existing_debts_option_5', 'option', 'income_details', 'calculate_credit_3', 'No existing debts', true, 'calculate_credit_existing_debts_option_5', NOW(), NOW()),

-- Monthly Debt Payments field
('calculate_credit_monthly_debt_payments', 'field_label', 'income_details', 'calculate_credit_3', 'Monthly debt payments field label', true, 'calculate_credit_monthly_debt_payments', NOW(), NOW()),
('calculate_credit_monthly_debt_payments_ph', 'placeholder', 'income_details', 'calculate_credit_3', 'Monthly debt payments placeholder', true, 'calculate_credit_monthly_debt_payments_ph', NOW(), NOW()),

-- Navigation buttons
('calculate_credit_step3_next_button', 'button', 'navigation', 'calculate_credit_3', 'Next step button', true, 'calculate_credit_step3_next_button', NOW(), NOW()),
('calculate_credit_step3_back_button', 'button', 'navigation', 'calculate_credit_3', 'Back step button', true, 'calculate_credit_step3_back_button', NOW(), NOW())
