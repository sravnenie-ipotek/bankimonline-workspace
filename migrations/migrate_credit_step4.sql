...
-- Main title
('calculate_credit_step4_title', 'title', 'navigation', 'calculate_credit_4', 'Step 4 main title', true, 'calculate_credit_step4_title', NOW(), NOW()),

-- Results section
('calculate_credit_results_title', 'title', 'results', 'calculate_credit_4', 'Results section title', true, 'calculate_credit_results_title', NOW(), NOW()),
('calculate_credit_results_subtitle', 'text', 'results', 'calculate_credit_4', 'Results section subtitle', true, 'calculate_credit_results_subtitle', NOW(), NOW()),

-- Filter options
('calculate_credit_filter_title', 'title', 'filters', 'calculate_credit_4', 'Filter section title', true, 'calculate_credit_filter_title', NOW(), NOW()),
('calculate_credit_filter_option_1', 'option', 'filters', 'calculate_credit_4', 'Show all offers', true, 'calculate_credit_filter_option_1', NOW(), NOW()),
('calculate_credit_filter_option_2', 'option', 'filters', 'calculate_credit_4', 'Best interest rate', true, 'calculate_credit_filter_option_2', NOW(), NOW()),
('calculate_credit_filter_option_3', 'option', 'filters', 'calculate_credit_4', 'Lowest monthly payment', true, 'calculate_credit_filter_option_3', NOW(), NOW()),
('calculate_credit_filter_option_4', 'option', 'filters', 'calculate_credit_4', 'Shortest repayment period', true, 'calculate_credit_filter_option_4', NOW(), NOW()),

-- Bank offer card fields
('calculate_credit_bank_name', 'field_label', 'bank_offers', 'calculate_credit_4', 'Bank name label', true, 'calculate_credit_bank_name', NOW(), NOW()),
('calculate_credit_interest_rate', 'field_label', 'bank_offers', 'calculate_credit_4', 'Interest rate label', true, 'calculate_credit_interest_rate', NOW(), NOW()),
('calculate_credit_monthly_payment', 'field_label', 'bank_offers', 'calculate_credit_4', 'Monthly payment label', true, 'calculate_credit_monthly_payment', NOW(), NOW()),
('calculate_credit_total_cost', 'field_label', 'bank_offers', 'calculate_credit_4', 'Total cost label', true, 'calculate_credit_total_cost', NOW(), NOW()),
('calculate_credit_loan_term', 'field_label', 'bank_offers', 'calculate_credit_4', 'Loan term label', true, 'calculate_credit_loan_term', NOW(), NOW()),
('calculate_credit_processing_fee', 'field_label', 'bank_offers', 'calculate_credit_4', 'Processing fee label', true, 'calculate_credit_processing_fee', NOW(), NOW()),

-- Action buttons
('calculate_credit_apply_button', 'button', 'bank_offers', 'calculate_credit_4', 'Apply button', true, 'calculate_credit_apply_button', NOW(), NOW()),
('calculate_credit_details_button', 'button', 'bank_offers', 'calculate_credit_4', 'View details button', true, 'calculate_credit_details_button', NOW(), NOW()),
('calculate_credit_compare_button', 'button', 'bank_offers', 'calculate_credit_4', 'Compare offers button', true, 'calculate_credit_compare_button', NOW(), NOW()),

-- Warning messages
('calculate_credit_warning_income', 'text', 'warnings', 'calculate_credit_4', 'Low income warning', true, 'calculate_credit_warning_income', NOW(), NOW()),
('calculate_credit_warning_debt_ratio', 'text', 'warnings', 'calculate_credit_4', 'High debt ratio warning', true, 'calculate_credit_warning_debt_ratio', NOW(), NOW()),
('calculate_credit_warning_credit_history', 'text', 'warnings', 'calculate_credit_4', 'Credit history warning', true, 'calculate_credit_warning_credit_history', NOW(), NOW()),

-- Information texts
('calculate_credit_info_calculation_basis', 'text', 'information', 'calculate_credit_4', 'Calculation basis info', true, 'calculate_credit_info_calculation_basis', NOW(), NOW()),
('calculate_credit_info_rates_subject_change', 'text', 'information', 'calculate_credit_4', 'Rates subject to change info', true, 'calculate_credit_info_rates_subject_change', NOW(), NOW()),
('calculate_credit_info_approval_requirements', 'text', 'information', 'calculate_credit_4', 'Approval requirements info', true, 'calculate_credit_info_approval_requirements', NOW(), NOW()),

-- No results message
('calculate_credit_no_results_title', 'title', 'no_results', 'calculate_credit_4', 'No results title', true, 'calculate_credit_no_results_title', NOW(), NOW()),
('calculate_credit_no_results_message', 'text', 'no_results', 'calculate_credit_4', 'No results message', true, 'calculate_credit_no_results_message', NOW(), NOW()),
('calculate_credit_no_results_suggestions', 'text', 'no_results', 'calculate_credit_4', 'No results suggestions', true, 'calculate_credit_no_results_suggestions', NOW(), NOW()),

-- Navigation buttons
('calculate_credit_step4_back_button', 'button', 'navigation', 'calculate_credit_4', 'Back step button', true, 'calculate_credit_step4_back_button', NOW(), NOW()),
('calculate_credit_step4_restart_button', 'button', 'navigation', 'calculate_credit_4', 'Restart calculation button', true, 'calculate_credit_step4_restart_button', NOW(), NOW())
