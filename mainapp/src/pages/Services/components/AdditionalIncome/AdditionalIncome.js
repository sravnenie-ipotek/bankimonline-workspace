...
const AdditionalIncome = () => {
    ...
    return (_jsxs(Column, { children: [_jsx(DropdownMenu, { title: t('calculate_mortgage_has_additional'), placeholder: t('calculate_mortgage_has_additional_ph'), data: AdditionalIncomeOptions, value: values.additionalIncome, onChange: (value) => setFieldValue('additionalIncome', value), onBlur: () => setFieldTouched('additionalIncome'), error: touched.additionalIncome && errors.additionalIncome }), _jsx(AddInc, {})] }));
};
