...
const SecondStepForm = () => {
    ...
    return (_jsx(_Fragment, { children: _jsxs(FormContainer, { children: [_jsx(FormCaption, { title: t('calculate_mortgage_step2_title') }), _jsxs(RowTwo, { children: [_jsx(Info, {}), _jsx(UserProfileCard, { name: userData?.nameSurname, phone: userData?.phoneNumber })] }), _jsxs(Row, { children: [_jsx(NameSurname, {}), _jsx(Birthday, {}), _jsx(Education, {})] }), _jsxs(Row, { children: [_jsxs(Column, { style: { gap: '2rem' }, children: [_jsx(AdditionalCitizenship, {}), values.additionalCitizenships === 'yes' && (_jsx(CitizenshipsDropdown, {}))] }), _jsxs(Column, { style: { gap: '2rem' }, children: [_jsx(Taxes, {}), values.taxes === 'yes' && _jsx(CountriesPayTaxes, {})] }), _jsxs(Column, { style: { gap: '2rem' }, children: [_jsx(Childrens, {}), values.childrens === 'yes' && _jsx(HowMuchChildrens, {})] })] }), _jsx(Divider, {}), _jsxs(Row, { children: [_jsx(MedicalInsurance, {}), _jsx(IsForeigner, {}), _jsx(PublicPerson, {})] }), _jsx(Divider, {}), _jsxs(Row, { children: [_jsx(Borrowers, {}), _jsx(Column, {}), _jsx(Column, {})] }), _jsx(Divider, {}), _jsxs(Row, { children: [_jsx(FamilyStatus, {}), _jsx(Column, { children: values.familyStatus === 'option_2' && _jsx(PartnerPayMortgage, {}) }), _jsx(Column, { children: values.partnerPayMortgage === 'yes' &&
